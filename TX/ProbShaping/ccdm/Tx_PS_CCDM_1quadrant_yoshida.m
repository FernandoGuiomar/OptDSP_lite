function [Stx,txSyms,R_CCDM] = Tx_PS_CCDM_1quadrant_yoshida(C,lambda,txBits)
...
% lambda = entropy2lambda(2.33,C_1quad);
lambda = entropy2lambda(5,C_1quad);
% lambda = entropy2lambda(2,C_1quad);
